  ...
  return (
    <footer className="hero__background">
      <div className="footer__info">
        ...
        <p><a className="complementary__color" href="mailto:gabriel@inter-action.design?subject=I%20would%20like%20to%20work%20with%20you">gabriel@inter-action.design</a></p>
